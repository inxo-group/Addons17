...
class AccountAccount(models.Model):
    ...
    box_it1 = fields.Selection(
        ...
        selection=[
            ...
            (
                "I44",
                "I44 - GOODS OR SERVICES SUBJECT TO WITHHOLDING TO TAXPAYERS UNDER THE RST (Rule No. 01-11) "
                "(Operations Taxed at 18%)",
            ),
            (
                "I45",
                "I45 - GOODS OR SERVICES SUBJECT TO WITHHOLDING TO TAXPAYERS UNDER THE RST (Rule No. 01-11) "
                "(Operations Taxed at 16%)",
            ),
            (
                "I47",
                "I47 - ASSETS SUBJECT TO RETENTION OF PROOF OF PURCHASE (Operations Taxed at 18%) "
                "(Rule No. 08-10 and 05-19)",
            ),
            (
                "I48",
                "I48 - ASSETS SUBJECT TO RETENTION OF PROOF OF PURCHASE (Operations Taxed at 16%) "
                "(Rule No. 08-10 and 05-19)",
            ),
